        ...
        <div class="row row-cols-2">
            <div class="col">
                <div class="card text-center">
                    <div class="card-body">
                        <a href="listUser.php">
                            <img src="user.png" class="rounded mx-auto d-block" alt="..." style="height:150px; width:180px;">
                        </a>
                    </div>
                ...
                <div class="card text-center">
                    <div class="card-body">
                        <a href="listbarang.php">
                            <img src="barang.png" class="rounded mx-auto d-block" alt="..." style="height:150px; width:180px;">
                        </a>
                    </div>
                    <div class="card-footer text-muted">
                        Barang
                ...
                <div class="card text-center">
                    <div class="card-body">
                        <a href="listOrder.php">
                            <img src="order.png" class="rounded mx-auto d-block" alt="..." style="height:150px; width:180px;">
                        </a>
                    </div>
                    <div class="card-footer text-muted">
                        Order
                ...
                <div class="card text-center">
                    <div class="card-body">
                        <a href="listMember.php">
                            <img src="customer.png" class="rounded mx-auto d-block" alt="..." style="height:150px; width:180px;">
                        </a>
                    </div>
                    <div class="card-footer text-muted">
                        Member
